        ...
        <div className="mt-8 max-w-2xl mx-auto">
          <div className="relative">
            <Input
              ...
              className="w-full h-14 pl-6 pr-16 rounded-full bg-white/10 border-white/20 text-white placeholder:text-white/70 backdrop-blur-sm focus:bg-white/20 focus:ring-accent"
            />
